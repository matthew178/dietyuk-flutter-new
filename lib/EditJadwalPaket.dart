...
class EditJadwalPaket extends StatefulWidget {
  final String id;

  EditJadwalPaket({Key key, @required this.id}) : super(key: key);

  @override
  EditJadwalPaketState createState() => EditJadwalPaketState(this.id);
}
...
class EditJadwalPaketState extends State<EditJadwalPaket> {
  ...
  void hapusJadwal(String idpaket) async {
    ...
    http
        .post(Uri.parse(session.ipnumber + "/hapusjadwal"),
